...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  mar. 07 avr. 2020 à 23:34
...
(30, 'Programmation C', 'Ce cours sert a prends les principe de programmation C', 'GI'),
...
(49, 'gestion éé l', 'ce cours sert a rien', 'TCC');
...
(1, 'abdou', 'akheraz', '2015-01-01', 'GI', 456546, 'abdou@gmail.com', '0000', 'etudiant', '-1', 'Meknes'),
(2, 'agadiri', 'imad', '2015-01-01', 'GI', 456546, 'imad@gmail.com', '0000', 'etudiant', '-1', 'agadir'),
...
(10, 'ayoubi', 'safwa', '2015-01-01', 'TM', 456546, 'safwa@gmail.com', '0000', 'etudiant', '0', 'houcima'),
...
(20, 'laasili', 'soufian', '1111-11-11', 'GIM', 45555, 'bassma@gmail.com', '0000', 'etudiant', '0', 'Meknes'),
...
(23, 'corona', 'corona', '2020-03-20', 'GIM', 0, 'corona@gmail.com', 'corona', 'professeur', '0', 'china');
...
(3, 'HASSANI', 'MANAL', '2001-08-07', 'GIM', 614985235, 'MEKNES', 'manal.hassani14@gmail.com', '1234', 'etudiant'),
...
INSERT INTO `file` (`id_pdf`, `id_filiere`, `code_prof`, `commantaire`, `id_cour`, `type_cour`, `nbr_telechargement`, `date_ajoute`, `nom_pdf`, `pdf_lien`) VALUES
(1, 'TCC', 6, 'un commantaire', 47, 'tp', 0, '2020-03-23 21:53:03', '', '../aaa/aaa/aa'),
(3, 'TCC', 6, 'aaaaaaaaa', 47, 'tp', 0, '2020-03-23 22:19:22', 'tittttre', '../file/TCC/TP2.pdf'),
(8, 'TCC', 6, 'zzzz', 47, 'tp', 0, '2020-03-23 22:55:31', 'TP_3.pdf', '../file/TCC/TP_3.pdf'),
(7, 'TCC', 6, 'un tp de xx', 47, 'tp', 4, '2020-03-23 22:44:27', 'TP_Etat.pdf', '../file/TCC/TP_Etat.pdf'),
(6, 'TCC', 6, 'aaaaaaaaa', 47, 'tp', 2, '2020-03-23 22:22:55', 'TP2.pdf', '../file/TCC/TP2.pdf'),
(9, 'TCC', 6, 's', 47, 'tp', 0, '2020-03-23 22:56:39', 'TP_Activité.pdf', '../file/TCC/TP_Activité.pdf'),
(13, 'TCC', 6, 'koulchiiiiiiii', 48, 'cour', 0, '2020-03-26 20:44:24', 'HTML-partie1.pdf', '../file/TCC/HTML-partie1.pdf');
...
INSERT INTO `filiere` (`filiere_id`, `filiere`, `filiere_description`) VALUES
('GI', 'GENIE INFORMATIQUE', 'bonjour c estu petite desc a propos de la filiere'),
('TM', 'TECHNIQUE DE MANAGEMENT', 'bonjour c estu petite desc a propos de la filiere'),
('TSI', 'TECHNIQUE DE SON ET D IMAGE', 'bonjour c estu petite desc a propos de la filiere'),
('GIM', 'GENIE INDUSTRIEL ET MAINTENANCE', 'bonjour c estu petite desc a propos de la filiere'),
('GC', 'GENEIE CIVIL', 'bonjour c estu petite desc a propos de la filiere'),
('GE', 'GENIE ELECTRIQUE', 'bonjour c estu petite desc a propos de la filiere'),
('GTE', 'GENIE TERMIQUE ET ENERGETIQUE', 'bonjour c estu petite desc a propos de la filiere'),
('FBA', 'FINANCE BANQUE ET ASSURANCE', 'c est une filiere de FBA'),
('TCC', 'TECHNIQUE DE COMMUNICATION COMMERCIALISATION', 'bonjour c estu petite desc a propos de la filiere'),
('IA', 'Inteligence artificiel', 'Filiere de inteligence artificiel');
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `etat` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_msg`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `message` (`id_msg`, `name`, `message`, `email`, `telephone`, `type`, `code_user`, `etat`) VALUES
(1, 'hassan benani', 'ceci est un test ', 'hassa@gmail.com', 6544741, 'visiteur', -1, '1'),
(2, 'LOUKILI HASSAN', 'un message de mois prof hassan', 'hassan.loukili@gmail.com', 603254861, 'professeur', 6, NULL),
(3, 'LOUKILI HASSAN', 'un test n 2 depuis hassan loukili', 'hassan.loukili@gmail.com', 603254861, 'professeur', 6, NULL);
...
(12, 'ABOUKHADIJA', 'IDRISS', '1978-06-11', 'GI', 632156784, 'idriss.abou@gmail.com', '1234', 'professeur', NULL),
...
(2, 'ELAHMADI', 'ABDELKADER', '1987-04-05', 'FBA', 625455475, 'elahmadi.abd@gmail.com', '1234', 'professeur', NULL);
...
CREATE TABLE IF NOT EXISTS `replymessage` (
  ...
  `type_recepteur` enum('etudiant','professeur','visiteur') DEFAULT NULL,
  `id_msg_recepteur` int(11) NOT NULL,
  PRIMARY KEY (`id_msg`),
  KEY `id_msg_recepteur` (`id_msg_recepteur`)
...
INSERT INTO `replymessage` (`id_msg`, `id_admin`, `message`, `id_recepteur`, `type_recepteur`, `id_msg_recepteur`) VALUES
(1, 1, 'un test de reponse', -1, 'visiteur', 1);
...
INSERT INTO `competance` (`id_cmpt`, `nom_cmpt`) VALUES
(1, 'Développement Web'),
...
--
-- Structure de la table `competance_detail`
--

DROP TABLE IF EXISTS `competance_detail`;
CREATE TABLE IF NOT EXISTS `competance_detail` (
...
--
-- Déchargement des données de la table `competance_detail`
--

INSERT INTO `competance_detail` (`id_det`, `id_cmpt`, `description`) VALUES
(1, 1, 'HTML5'),
(2, 1, 'CSS'),
(3, 1, 'JavaScript'),
(4, 1, 'SQL'),
...
INSERT INTO `education` (`id_edu`, `nom`, `description`, `duree`) VALUES
(1, 'ecole superieure de technologie meknes', '2eme annee en genie informatique', '2018-2020'),
(2, 'Lycee tarik bn, Ziad meknes', 'Baccalaureat en Sciences physiques Mention : Bien', 'Juin 2018');
...
INSERT INTO `experience` (`id_exp`, `nom`, `description`) VALUES
(1, 'stage', 'un stage d un mois au seIn dE l entreprise CACIOPEE A RABAT');
...
INSERT INTO `message` (`id`, `name`, `telephone`, `email`, `message`) VALUES
(1, 'ayman', 65412, 'aiman@gmail.com', 'un test\r\n'),
(2, 'ayman', 56156, 'aiman@gmail.com', 'un test'),
(3, 'ayman', 4444, 'aiman@gmail.com', 'ddd'),
(4, 'ayman', 4444, 'aiman@gmail.com', 'ddd'),
(5, 'hassan', 7777, 'hassan@gmail.com', 'un 2 test\r\n');
...
(1, 'realisation d un site web', 'realisation d un site web d une ecole primaire avec wordpress'),
(2, 'realisation d un site web', 'realisation d un site web ddu tram way Meknes'),
(3, 'realisation d un site web', 'realisation d un site web ELEARNING womme projet de fin d etude');
COMMIT;
