...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  jeu. 04 juin 2020 à 07:59
...
(26, 'Pythone', 'Ce cours permet d\'améliorer les compétences du programmation avec langage Phythone', 'IA', '2020-06-04 05:25:56', '2020-06-04 05:25:56'),
...
(25, 'Deep Learning', 'Le deep learning ou apprentissage profond est un type d\'intelligence artificielle dérivé du machine learning (apprentissage automatique) où la machine est capable d\'apprendre par elle-même,', 'IA', '2020-06-04 05:03:24', '2020-06-04 05:03:24'),
(27, 'Machine Learning', 'Machine learning is an application of artificial intelligence (AI) that provides systems the ability to automatically learn and improve from experience without being explicitly programmed.', 'IA', '2020-06-04 05:28:05', '2020-06-04 05:28:05');
...
(55, 'ia', 21, 'introduction du Deep learning', 25, 'cour', 0, '2020-06-04 07:30:01', 'Intro_deep learning.txt', 'public/file//Intro_deep learning.txt', 'Indroduction deep learning', '2020-06-04 05:30:01', '2020-06-04 05:30:01'),
(56, 'ia', 21, 'Introduction du Machine learning', 27, 'cour', 0, '2020-06-04 07:30:57', 'Intro_machine learning.txt', 'public/file//Intro_machine learning.txt', 'Indroduction Machine learning', '2020-06-04 05:30:57', '2020-06-04 05:30:57'),
(57, 'ia', 21, 'Introduction Language programmation Python', 26, 'cour', 0, '2020-06-04 07:32:20', 'Intro_Python.txt', 'public/file//Intro_Python.txt', 'Indroduction Python', '2020-06-04 05:32:20', '2020-06-04 05:32:20'),
(58, 'ia', 21, 'Programmer une simple implication avec python.', 26, 'tp', 0, '2020-06-04 07:33:40', 'TP1_Python.txt', 'public/file//TP1_Python.txt', 'Python simple application', '2020-06-04 05:33:40', '2020-06-04 05:33:40'),
(59, 'ia', 21, 'TP a faire rapidement', 26, 'tp', 0, '2020-06-04 07:35:36', 'TP2_Python.txt', 'public/file//TP2_Python.txt', 'Python avancées', '2020-06-04 05:35:36', '2020-06-04 05:35:36'),
(60, 'ia', 21, 'Premiere td de deep learning', 25, 'td', 0, '2020-06-04 07:37:31', 'Td_deep learning.txt', 'public/file//Td_deep learning.txt', 'Deep Learning', '2020-06-04 05:37:31', '2020-06-04 05:37:31'),
(61, 'ia', 21, 'Premiere td de Machine Learning', 27, 'td', 0, '2020-06-04 07:40:55', 'Td_machine learning.txt', 'public/file//Td_machine learning.txt', 'Machine Learning', '2020-06-04 05:40:55', '2020-06-04 05:40:55');
...
(15, 1, 'Which type of concurrency is best for CPU-bound programs?', 'Dictionaries', 'Threading', 'Multiprocessing', '2020-06-04 05:47:44', '2020-06-04 05:47:44'),
(15, 2, 'If you have a CPU-bound program and you’re going to use the multiprocessing library, what’s a good number of processes to create?', 'One process for each CPU', 'As many as possible', '1000', '2020-06-04 05:47:44', '2020-06-04 05:47:44'),
(15, 3, 'You have an I/O-bound program that takes about 2 seconds to run and that only gets run once a week. Which concurrency library should you use?', 'You should not use concurrency.', 'Multiprocessing', 'Threading', '2020-06-04 05:47:44', '2020-06-04 05:47:44'),
(16, 1, 'Given the following function fun1() Please select the correct function calls \"def fun1(name, age):     print(name, age)\"', 'fun1(name=’Emma’, age=23)', 'fun1(name=’Emma’, 23)', 'fun1(‘Emma’, 23)', '2020-06-04 05:57:54', '2020-06-04 05:57:54'),
(16, 2, 'Select which true for Python function :', 'A function is a code block that only executes when it is called.', 'A function only executes when it is called and we can reuse it in a program', 'Python function always returns a value.', '2020-06-04 05:57:55', '2020-06-04 05:57:55'),
(16, 3, 'What is the output of the following for loop and  range() function \"for num in range(-2,-5,-1):     print(num, end=\", \")\"?', '-2, -1, -3, -4', '-2, -1, 0, 1, 2, 3,', '-2, -3, -4,', '2020-06-04 05:57:55', '2020-06-04 05:57:55');
...
(15, 'Pythone', 21, 'ia', '2020-07-16 09:45:00', '2020-06-04 07:47:44', '2020-06-04 05:47:44', '2020-06-04 05:47:44'),
(16, 'Python Functions Quiz', 21, 'ia', '2020-07-16 09:45:00', '2020-06-04 07:57:54', '2020-06-04 05:57:54', '2020-06-04 05:57:54');
...
(21, 'alami', 'azzedine', '1995-10-06', '0657211147', 'ia', 'alamiazzedine@gmail.com', '$2y$10$3UGD57FBAWzEpf7gkurQoed0Lr0FPUsoona0sV1BXo4Fw0Gqi12GK', 'Laayoune', 'professeur', '2020-06-03 06:13:19', '2020-06-04 04:57:21'),
