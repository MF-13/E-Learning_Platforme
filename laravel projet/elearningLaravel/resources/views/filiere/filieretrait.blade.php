          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" name="departement" class="form-control" required="required" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ex : genie informatique" >
              </div>
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
