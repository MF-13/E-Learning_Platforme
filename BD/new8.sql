...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  sam. 18 avr. 2020 à 14:17
...
(29, 'tcc', 141, 'n', 45, 'cour', 0, '2020-04-17 10:57:00', '@ReadMe.txt', '../file/tcc/@ReadMe.txt', 'un pdf de x et y '),
(27, 'tcc', 141, 'tp de macro a rendre', 47, 'tp', 0, '2020-04-17 10:29:42', '@ReadMe.txt', '../file/tcc/@ReadMe.txt', 'TP MACRO'),
(28, 'tcc', 141, 'a rendre', 46, 'td', 0, '2020-04-17 10:45:14', '@ReadMe.txt', '../file/tcc/@ReadMe.txt', 'test '),
...
(21, 'bibl', 6, 'test biblio', -1, 'bibliotheque', 1, '2020-04-13 15:18:37', '@ReadMe.txt', '../file/bibliotheque/@ReadMe.txt', 'Exemple PFE');
...
CREATE TABLE IF NOT EXISTS `quiz` (
  ...
  `dernier_delai` datetime NOT NULL,
  PRIMARY KEY (`id_quiz`),
  KEY `id_prof` (`id_prof`),
  KEY `id_filiere` (`id_filiere`)
...
INSERT INTO `quiz` (`id_quiz`, `nom_quiz`, `id_prof`, `id_filiere`, `dernier_delai`) VALUES
(1, 'quiz de test', 6, 'tcc', '2020-04-08 11:11:11');
